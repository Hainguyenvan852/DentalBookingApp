      ...
      builder:(context, snap) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            return AppointmentNotifField(title: 'Thông báo lịch hẹn', message: snap.data![index].message, createdAt: snap.data![index].createdAt, isRead: snap.data![index].isRead,);
          },
        );
      }
    );
...
class AppointmentNotifField extends StatelessWidget {
  const AppointmentNotifField({super.key, required this.title, required this.message, required this.createdAt, required this.isRead});
  final String title;
