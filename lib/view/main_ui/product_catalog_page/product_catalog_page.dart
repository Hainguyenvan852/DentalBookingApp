...
class _ProductCatalogPageState extends State<ProductCatalogPage> {
  ...
  void initState() {
    ...
    _catalogsFuture.then((cats) {
      ...
      setState(() {}); // kích hoạt build sau khi có danh mục đầu tiên
    });
  }
        ...
        child: Row(
          children: [
            ...
            ElevatedButton(
              ...
              child: const Text('Mua ngay', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 10)),
            )
          ],
        ),
      ),
